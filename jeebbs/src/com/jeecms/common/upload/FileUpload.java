...
public class FileUpload {
	...
	*/
	...
	public static String uploadFileWithHttpMime(
			Integer postId,String code,String type,
       ...
       //HttpClient  
	    ...
	    try {  
	        ...
	        builder.addTextBody("postId", postId.toString());
	        builder.addTextBody("code", code.toString());
	        if(StringUtils.isNotBlank(type)){
	 ...
	 */  
	public static String uploadFileWithHttpMime(
			String type,String url,String filePath,
       ...
       //HttpClient  
	    ...
	    try {  
	        ...
	        builder.addTextBody("nonce_str", nonce_str);
	        builder.addTextBody("sign", sign);
	        builder.addTextBody("sessionKey", sessionKey);
	...
	public static String uploadFile(
			String root,String url,String filePath,
			String appId,String sessionKey,String nonce_str,String sign) {  
	    // 实例化post提交方式  
	    HttpPost post = new HttpPost(url);  
	    //创建HttpClientBuilder  
