...
public class Finder {
	...
	protected Finder(String hql,String pageHql) {
		hqlBuilder = new StringBuilder(hql);
		pageBuilder = new StringBuilder(pageHql);
	}
	...
	public static Finder create(String hql,String getPageHql) {
		return new Finder(hql,getPageHql);
	}
	...
	private String getRowCountBaseHql(String indexKey) {
		...
		if(pageBuilder!=null){
			String pageHql=pageBuilder.toString();
			if(StringUtils.isNotBlank(pageHql)){
				hql=pageHql;
				return hql;
			}
		}
