...
public class LivePageDirective implements TemplateDirectiveModel {
	/**
	 * 输入参数，用户ID。
	 */
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars,
		...
		Pagination pagination = liveMng.getPage(chapterId, title, 
				userId, BbsLive.CHECKED, queryStartBegin, queryStartEnd,
				queryFinishBegin,queryFinishEnd,orderBy, FrontUtils.getPageNo(env), 
