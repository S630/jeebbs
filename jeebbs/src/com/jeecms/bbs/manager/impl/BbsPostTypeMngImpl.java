...
public class BbsPostTypeMngImpl implements BbsPostTypeMng {
	...
	public List<BbsPostType> getList(Integer siteId,Integer forumId,Integer parentId) {
		List<BbsPostType> list = dao.getList(siteId,forumId,parentId);
		return list;
	}
	
	@Transactional(readOnly = true)
	public BbsPostType getDefault(Integer siteId,Integer forumId){
		List<BbsPostType> list = dao.getList(siteId,forumId,null);
