...
public class BbsPostTypeDirective implements TemplateDirectiveModel {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars,
		...
		Map<String, TemplateModel> paramWrap = new HashMap<String, TemplateModel>(
				params);
		paramWrap.put(OUT_LIST, DefaultObjectWrapperBuilderFactory.getDefaultObjectWrapper().wrap(postTypes));
		paramWrap.put(CHILD_LIST, DefaultObjectWrapperBuilderFactory.getDefaultObjectWrapper().wrap(childPostTypes));
