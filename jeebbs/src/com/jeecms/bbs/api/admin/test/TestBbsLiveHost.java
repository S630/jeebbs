...
public class TestBbsLiveHost {
	...
	private static String testLivePriority(){
		String url = base+"/liveHost/priority";
		StringBuffer paramBuff = new StringBuffer();
		paramBuff.append("ids="+"5,6");
		paramBuff.append("&priorities="+"1,2");
		paramBuff.append("&appId="+appId);
		String encryptSessionKey = "";
		try {
			encryptSessionKey = AES128Util.encrypt(sessionKey, aesKey, ivKey);
