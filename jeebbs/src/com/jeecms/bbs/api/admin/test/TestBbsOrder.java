...
public class TestBbsOrder {
	...
	public static void main(String[] args) {
		System.out.println(testOrderUser());
	}
	
	private static String testOrderList(){
		String url = base+"/order/charge_list";
		StringBuffer paramBuff = new StringBuffer();
		paramBuff.append("pageNo="+1);
		paramBuff.append("&pageSize="+10);
		paramBuff.append("&title=");
		paramBuff.append("&author=");
		paramBuff.append("&buyTimeBegin=");
		paramBuff.append("&buyTimeEnd=");
	...
	private static String testOrderCommissionStatic(){
		String url = base+"/order/commissionStatic";
		StringBuffer paramBuff = new StringBuffer();
		paramBuff.append("appId="+appId);
		String encryptSessionKey = "";
		try {
	...
	private static String testOrderAccount(){
		String url = base+"/order/account_list";
		StringBuffer paramBuff = new StringBuffer();
		paramBuff.append("pageNo="+1);
		paramBuff.append("&pageSize="+10);
		paramBuff.append("&username=");
		paramBuff.append("&drawTimeBegin=");
		paramBuff.append("&drawTimeEnd=");
		paramBuff.append("&orderBy=");
		paramBuff.append("&appId="+appId);
		String encryptSessionKey = "";
		try {
	...
	private static String testOrderUser(){
		String url = base+"/order/user_order_list";
		StringBuffer paramBuff = new StringBuffer();
		paramBuff.append("pageNo="+1);
		paramBuff.append("&pageSize="+10);
		paramBuff.append("&orderNum=");
		paramBuff.append("&buyusername=");
		paramBuff.append("&authorusername=");
		paramBuff.append("&payMode=");
		paramBuff.append("&dataType=");
		paramBuff.append("&dataId=");
		paramBuff.append("&appId="+appId);
		String encryptSessionKey = "";
		try {
			encryptSessionKey = AES128Util.encrypt(sessionKey, aesKey, ivKey);
	...
	private static String testAccountDrawDel(){
		String url = base+"/accountDraw/delete";
		StringBuffer paramBuff = new StringBuffer();
