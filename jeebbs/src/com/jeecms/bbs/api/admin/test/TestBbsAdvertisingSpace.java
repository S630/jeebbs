...
public class TestBbsAdvertisingSpace {
	...
	private static String testSpaceList(){
		String url = base+"/advertisingSpace/list";
	...
	private static String testSpaceGet(){
		String url = base+"/advertisingSpace/get";
		StringBuffer paramBuff = new StringBuffer();
	...
	private static String testSpaceSave(){
		String url = base+"/advertisingSpace/save";
		StringBuffer paramBuff = new StringBuffer();
		paramBuff.append("name="+"ceshi");//名称
		paramBuff.append("&description="+"");//描述
		paramBuff.append("&previewImg="+"/jee/jee");//图片地址
		paramBuff.append("&enabled="+true);//是否启用 
		paramBuff.append("&appId="+appId);
		String encryptSessionKey = "";
		try {
			encryptSessionKey = AES128Util.encrypt(sessionKey, aesKey, ivKey);
	...
	private static String testSpaceUdp(){
		String url = base+"/advertisingSpace/update";
		StringBuffer paramBuff = new StringBuffer();
		paramBuff.append("id="+5);//名称
		paramBuff.append("&name="+"ceshi2");//名称
		paramBuff.append("&description="+"");//描述
		paramBuff.append("&previewImg="+"/jee/jee");//图片地址
		paramBuff.append("&enabled="+false);//是否启用 
		paramBuff.append("&appId="+appId);
		String encryptSessionKey = "";
		try {
			encryptSessionKey = AES128Util.encrypt(sessionKey, aesKey, ivKey);
	...
	private static String testSpaceDel(){
		String url = base+"/advertisingSpace/delete";
		StringBuffer paramBuff = new StringBuffer();
		paramBuff.append("ids="+"5");//名称
		paramBuff.append("&appId="+appId);
		String encryptSessionKey = "";
		try {
			encryptSessionKey = AES128Util.encrypt(sessionKey, aesKey, ivKey);
