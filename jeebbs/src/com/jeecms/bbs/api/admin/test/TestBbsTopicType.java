...
public class TestBbsTopicType {
	...
	private static String testTopicTypeGet(){
		String url = base+"/topicType/get";
		StringBuffer paramBuff = new StringBuffer();
	...
	private static String testTopicTypeSave(){
		String url = base+"/topicType/save";
		StringBuffer paramBuff = new StringBuffer();
		paramBuff.append("name="+"ceshi22");
		paramBuff.append("&path="+"/jee/jee");
		paramBuff.append("&priority="+10);
		paramBuff.append("&display="+true);
		paramBuff.append("&typeLog=");
		paramBuff.append("&description=");
		paramBuff.append("&root=");
		paramBuff.append("&appId="+appId);
		String encryptSessionKey = "";
		try {
	...
	private static String testTopicTypeUpd(){
		String url = base+"/topicType/update";
		StringBuffer paramBuff = new StringBuffer();
		paramBuff.append("id="+13);
	...
	private static String testTopicTypeDel(){
		String url = base+"/topicType/delete";
		StringBuffer paramBuff = new StringBuffer();
		paramBuff.append("ids="+"13,14");
		paramBuff.append("&appId="+appId);
		String encryptSessionKey = "";
		try {
			encryptSessionKey = AES128Util.encrypt(sessionKey, aesKey, ivKey);
	...
	private static String testTopicTypeTree(){
		String url = base+"/topicType/tree";
		StringBuffer paramBuff = new StringBuffer();
		paramBuff.append("root=");
		paramBuff.append("&appId="+appId);
		String encryptSessionKey = "";
