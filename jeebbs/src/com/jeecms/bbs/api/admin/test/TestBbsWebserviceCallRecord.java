...
public class TestBbsWebserviceCallRecord {
	...
	public static void main(String[] args) {
		System.out.println(testRecordGet());
	}
	
	private static String testRecordList(){
		String url = base+"/webserviceCallRecord/list";
	...
	private static String testRecordGet(){
		String url = base+"/webserviceCallRecord/get";
		StringBuffer paramBuff = new StringBuffer();
	...
	private static String testRecordDel(){
		String url = base+"/webserviceCallRecord/delete";
		StringBuffer paramBuff = new StringBuffer();
