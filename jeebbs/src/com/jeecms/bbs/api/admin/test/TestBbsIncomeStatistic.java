...
public class TestBbsIncomeStatistic {
	...
	private static String testStatistic(){
		String url = base+"/data/incomeStatistic_list";
		StringBuffer paramBuff = new StringBuffer();
		paramBuff.append("pageNo="+1);
		paramBuff.append("&pageSize="+10);
		paramBuff.append("&begin="+"2017-08-09");
	...
	private static String testStatisticGet(){
		String url = base+"/data/incomeStatistic_get";
		StringBuffer paramBuff = new StringBuffer();
