...
public class TestBbsLiveConfig {
	...
	private static String sessionKey="5FDF3EA169BF6B589921178C177AE6AF";
	private static String aesKey="MnYg7Tm8NR1YiYBJ";
	private static String ivKey="yToM65IuE64VDoEq";
	
	public static void main(String[] args) {
		System.out.println(testLiveConfigGet());
	}
	
	private static String testLiveConfigGet(){
		String url = base+"/live/config_get";
	...
	private static String testLiveUpd(){
		String url = base+"/live/config_update";
		StringBuffer paramBuff = new StringBuffer();
		paramBuff.append("liveCheck="+false);
		paramBuff.append("&appId="+appId);
		String encryptSessionKey = "";
		try {
			encryptSessionKey = AES128Util.encrypt(sessionKey, aesKey, ivKey);
