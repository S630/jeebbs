...
public class TestApiAccount {
	...
	public static void main(String[] args) {
		System.out.println(testApiAccountList());
	}
	private static String testApiAccountList(){
		String url = base+"/apiAccount/list";
	...
	//管理员与会员查询详情接口相同，通过查询后的apiAccount参数可进行区分是否为管理员
	private static String testApiAccountGet(){
		String url = base+"/apiAccount/get";
		StringBuffer paramBuff = new StringBuffer();
	...
	private static String testApiAccountSave(){
		String url = base+"/apiAccount/save";
		StringBuffer paramBuff = new StringBuffer();
		paramBuff.append("appId="+"7628458313434151");
		paramBuff.append("&appKey="+"a81zDx8O9rTKR2mk7ubIEMcnayeOYe4L");
		paramBuff.append("&aesKey="+"ppcwBQhca1bPhO77");
		paramBuff.append("&ivKey="+"F4VdqEd59l7V5LT1");
	...
	private static String testApiAccountUpd(){
		String url = base+"/apiAccount/update";
		StringBuffer paramBuff = new StringBuffer();
	...
	private static String testApiAccountDel(){
		String url=base+"/apiAccount/delete";
		StringBuffer paramBuff=new StringBuffer();
