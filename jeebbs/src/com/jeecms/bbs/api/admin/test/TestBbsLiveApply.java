...
public class TestBbsLiveApply {
	...
	private static String sessionKey="1E9E2F4F373DBE1852111E61E9724080";
	private static String aesKey="MnYg7Tm8NR1YiYBJ";
	private static String ivKey="yToM65IuE64VDoEq";
	
	public static void main(String[] args) {
		System.out.println(testLiveApplyGEt());
	}
	
	private static String testLiveApplyList(){
		String url = base+"/liveApply/list";
		StringBuffer paramBuff = new StringBuffer();
		paramBuff.append("pageNo="+1);
		paramBuff.append("&pageSize="+10);
		paramBuff.append("&mobile=");
	...
	private static String testLiveApplyGEt(){
		String url = base+"/liveApply/get";
		StringBuffer paramBuff = new StringBuffer();
