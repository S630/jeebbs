...
import com.jeecms.bbs.entity.BbsRole;
...
public abstract class BaseBbsRole  implements Serializable {
	 ...
	 */
	public BaseBbsRole (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	private java.util.Set<BbsUser> users;
	...
	public java.util.Set<BbsUser> getUsers() {
		return users;
	}

	public void setUsers(java.util.Set<BbsUser> users) {
		this.users = users;
	}

	public boolean equals (Object obj) {
		if (null == obj) return false;
		if (!(obj instanceof BbsRole)) return false;
		else {
			BbsRole cmsRole = (BbsRole) obj;
