...
/**
 * This is an object that contains data related to the bbs_account_pay table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="bbs_account_pay"
 */

public abstract class BaseBbsAccountPay  implements Serializable {

	public static String REF = "BbsAccountPay";
	 ...
	 */
	public BaseBbsAccountPay (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	// many to one
	private com.jeecms.bbs.entity.BbsUser payUser;
	 ...
	 */
	public com.jeecms.bbs.entity.BbsUser getPayUser () {
		return payUser;
	}
	 ...
	 */
	public void setPayUser (com.jeecms.bbs.entity.BbsUser payUser) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jeecms.bbs.entity.BbsAccountPay)) return false;
		else {
			com.jeecms.bbs.entity.BbsAccountPay bbsAccountPay = (com.jeecms.bbs.entity.BbsAccountPay) obj;
			if (null == this.getId() || null == bbsAccountPay.getId()) return false;
			else return (this.getId().equals(bbsAccountPay.getId()));
		}
	}
