...
public abstract class BaseBbsWebserviceCallRecord  implements Serializable {
	...
	// many to one
	private com.jeecms.bbs.entity.BbsWebserviceAuth auth;
	 ...
	 */
	public com.jeecms.bbs.entity.BbsWebserviceAuth getAuth () {
		return auth;
	}
	 ...
	 */
	public void setAuth (com.jeecms.bbs.entity.BbsWebserviceAuth auth) {
		this.auth = auth;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jeecms.bbs.entity.BbsWebserviceCallRecord)) return false;
		else {
			com.jeecms.bbs.entity.BbsWebserviceCallRecord bbsWebserviceCallRecord = (com.jeecms.bbs.entity.BbsWebserviceCallRecord) obj;
