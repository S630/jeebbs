 ...
 *
 * @hibernate.class
 *  table="jb_advertising"
 */

public abstract class BaseBbsAdvertising  implements Serializable {

	public static String REF = "BbsAdvertising";
	 ...
	 */
	public BaseBbsAdvertising (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	// many to one
	private com.jeecms.bbs.entity.BbsAdvertisingSpace adspace;
	 ...
	 */
	public com.jeecms.bbs.entity.BbsAdvertisingSpace getAdspace () {
		return adspace;
	}
	 ...
	 */
	public void setAdspace (com.jeecms.bbs.entity.BbsAdvertisingSpace adspace) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jeecms.bbs.entity.BbsAdvertising)) return false;
		else {
			com.jeecms.bbs.entity.BbsAdvertising cmsAdvertising = (com.jeecms.bbs.entity.BbsAdvertising) obj;
