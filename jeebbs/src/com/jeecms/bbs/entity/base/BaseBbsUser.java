...
public abstract class BaseBbsUser implements Serializable {
	...
	private Set<com.jeecms.bbs.entity.BbsTopicPostOperate> topicPostOperates;
	private java.util.Set<com.jeecms.bbs.entity.BbsUserAccount> userAccountSet;
	private java.util.Set<com.jeecms.plug.live.entity.BbsLiveUserAccount> liveUserAccountSet;
	private java.util.Set<com.jeecms.bbs.entity.BbsThirdAccount> thirdAccounts;
	...
	public java.lang.Boolean getLiveHost() {
		return liveHost;
	}

	public void setLiveHost(java.lang.Boolean liveHost) {
	...
	public java.lang.Long getTotalPoint() {
		return totalPoint;
	}
	...
	public Set<com.jeecms.bbs.entity.BbsTopicPostOperate> getTopicPostOperates() {
		return topicPostOperates;
	}

	public void setTopicPostOperates(Set<com.jeecms.bbs.entity.BbsTopicPostOperate> topicPostOperates) {
		this.topicPostOperates = topicPostOperates;
	}

	public java.util.Set<com.jeecms.bbs.entity.BbsUserAccount> getUserAccountSet() {
		return userAccountSet;
	}

	public void setUserAccountSet(java.util.Set<com.jeecms.bbs.entity.BbsUserAccount> userAccountSet) {
		this.userAccountSet = userAccountSet;
	}

	public java.util.Set<com.jeecms.plug.live.entity.BbsLiveUserAccount> getLiveUserAccountSet() {
		return liveUserAccountSet;
	}

	public void setLiveUserAccountSet(java.util.Set<com.jeecms.plug.live.entity.BbsLiveUserAccount> liveUserAccountSet) {
		this.liveUserAccountSet = liveUserAccountSet;
	}

	public java.util.Set<com.jeecms.bbs.entity.BbsThirdAccount> getThirdAccounts() {
		return thirdAccounts;
	}

	public void setThirdAccounts(java.util.Set<com.jeecms.bbs.entity.BbsThirdAccount> thirdAccounts) {
		this.thirdAccounts = thirdAccounts;
	}

	public java.util.Set<com.jeecms.bbs.entity.BbsUser> getMyAttentions() {
		return myAttentions;
	}

	public void setMyAttentions(java.util.Set<com.jeecms.bbs.entity.BbsUser> myAttentions) {
		this.myAttentions = myAttentions;
	}

	public java.util.Set<com.jeecms.bbs.entity.BbsUser> getMyFans() {
		return myFans;
	}

	public void setMyFans(java.util.Set<com.jeecms.bbs.entity.BbsUser> myFans) {
		this.myFans = myFans;
	}

	public java.util.Set<com.jeecms.bbs.entity.BbsGiftUser> getGifts() {
		return gifts;
	}

	public void setGifts(java.util.Set<com.jeecms.bbs.entity.BbsGiftUser> gifts) {
		this.gifts = gifts;
	}
