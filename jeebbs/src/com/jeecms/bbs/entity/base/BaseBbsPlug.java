...
public abstract class BaseBbsPlug  implements Serializable {
	 ...
	 */
	public BaseBbsPlug (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jeecms.bbs.entity.BbsPlug)) return false;
		else {
			com.jeecms.bbs.entity.BbsPlug cmsPlug = (com.jeecms.bbs.entity.BbsPlug) obj;
