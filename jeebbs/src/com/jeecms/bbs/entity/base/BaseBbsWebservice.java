...
/**
 * This is an object that contains data related to the bbs_webservice table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="bbs_webservice"
 */

public abstract class BaseBbsWebservice  implements Serializable {

	public static String REF = "BbsWebservice";
	 ...
	 */
	public BaseBbsWebservice (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	// collections
	private java.util.List<com.jeecms.bbs.entity.BbsWebserviceParam> params;
	 ...
	 */
	public java.util.List<com.jeecms.bbs.entity.BbsWebserviceParam> getParams () {
		return params;
	}
	 ...
	 */
	public void setParams (java.util.List<com.jeecms.bbs.entity.BbsWebserviceParam> params) {
		this.params = params;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jeecms.bbs.entity.BbsWebservice)) return false;
		else {
			com.jeecms.bbs.entity.BbsWebservice bbsWebservice = (com.jeecms.bbs.entity.BbsWebservice) obj;
			if (null == this.getId() || null == bbsWebservice.getId()) return false;
			else return (this.getId().equals(bbsWebservice.getId()));
		}
	}
