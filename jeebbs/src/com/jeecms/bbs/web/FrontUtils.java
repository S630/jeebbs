...
public class FrontUtils {
	...
	public static String getTplPath(HttpServletRequest request,
			CmsSite site, String dir, String name) {
	...
	public static String pageNotFound(HttpServletRequest request,
		...
		return getTplPath(request, site, TPLDIR_COMMON,
				PAGE_NOT_FOUND);
	}
	...
	public static String showSuccess(HttpServletRequest request,
		...
		return getTplPath(request, site, TPLDIR_COMMON,SUCCESS_PAGE);
	}
	...
	public static String showError(HttpServletRequest request,
		...
		return getTplPath(request, site, TPLDIR_COMMON,ERROR_PAGE);
	}
	...
	public static String showMessage(HttpServletRequest request,
		...
		return getTplPath(request, site, TPLDIR_COMMON,MESSAGE_PAGE);
	}
	...
	public static void frontData(HttpServletRequest request,
		...
		frontData(map, site, user, location, null, startTime,mobile);
	}

	public static void frontData(Map<String, Object> map, CmsSite site,
			BbsUser user, String location, String base, Long startTime,boolean mobile) {
		if (startTime != null) {
		...
		String res = ctxPath + RES_PATH + "/" + site.getPath() + "/"
				+ site.getTplSolution();
		if(mobile){
			res = ctxPath + RES_PATH + "/" + site.getPath() + "/"+ site.getTplMobileSolution();
		}
		// res路径需要去除第一个字符'/'
